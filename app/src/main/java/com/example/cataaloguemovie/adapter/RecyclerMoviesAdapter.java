package com.example.cataaloguemovie.adapter;
...
import com.example.cataaloguemovie.R;
import com.example.cataaloguemovie.activity.DetailActivity;
import com.example.cataaloguemovie.model.Result;
...
public class RecyclerMoviesAdapter extends RecyclerView.Adapter<RecyclerMoviesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerMoviesAdapter.MyViewHolder holder, int position) {
        ...
        Glide.with(mContext).load("https://image.tmdb.org/t/p/w500"+resultList.get(position).getPosterPath()).into(holder.tvPoster);
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tvPoster = itemView.findViewById(R.id.imgMovie);
